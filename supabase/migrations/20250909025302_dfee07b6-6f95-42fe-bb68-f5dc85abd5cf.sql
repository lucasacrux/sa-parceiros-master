-- Primeiro, adicionar as constraints únicas necessárias
ALTER TABLE public.consumers 
ADD CONSTRAINT consumers_cpf_tenant_unique UNIQUE (cpf, tenant_id);

ALTER TABLE public.contracts 
ADD CONSTRAINT contracts_number_tenant_unique UNIQUE (number, tenant_id);
