-- Adicionar constraints únicos necessários
...
-- Primeiro, limpar dados existentes se houverem
DELETE FROM public.debts WHERE tenant_id = (SELECT id FROM public.tenants WHERE slug = 'acrux' LIMIT 1);
DELETE FROM public.contracts WHERE tenant_id = (SELECT id FROM public.tenants WHERE slug = 'acrux' LIMIT 1);
DELETE FROM public.consumers WHERE tenant_id = (SELECT id FROM public.tenants WHERE slug = 'acrux' LIMIT 1);
